...
- Never modify Docs/Workflow/ files without user permission
...
**Starting a sprint:**
```
@workspace Open Sprint N for [description]. Read Docs/Workflow/ENTRY-GATE.md.
Run phases 0-3 before writing any code.
```
...
**Closing a sprint:**
```
@workspace Close Sprint N. Run the Close Gate from Docs/Workflow/CLOSE-GATE.md.
...
Use these via Copilot's terminal integration or run them manually alongside
Copilot Chat for reliable status tracking.
