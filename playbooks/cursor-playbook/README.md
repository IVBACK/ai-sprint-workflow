...
Docs/Workflow/ENTRY-GATE.md — phases 0-3, 12 steps. Do not write code
...
**Closing a sprint:**
```
Close Sprint N. Follow Close Gate in Docs/Workflow/CLOSE-GATE.md —
...
| `validate-close-gate.sh` | Manual: follow Close Gate checklist in Docs/Workflow/CLOSE-GATE.md |
| `validate-sprint-close.sh` | Manual: follow Sprint Close checklist in Docs/Workflow/SPRINT-CLOSE.md |
...
Cursor Agent mode can run these via terminal. Add to `.cursor/rules/workflow.mdc`
if you want the agent to use CLI tools for status updates.
